...
- **Timer Notifications**: Visual notification, 10-second crescendo sound alert (10 ascending beeps, quiet to loud), and browser notification when timer completes. Stop button also stops sound.
